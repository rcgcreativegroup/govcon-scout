...
- **Awards found:** 35 deduplicated award(s) from finalist-only queries.
- **Total returned award value:** $69,560,376
...
|---|---|---:|---|
| Query A - NAICS + agency | naics_codes=['561710']; agencies=[{'type': 'awarding', 'tier': 'toptier', 'name': 'DEPT OF DEFENSE'}] | 0 |  |
| Query B - PSC + agency | psc_codes=['S207']; agencies=[{'type': 'awarding', 'tier': 'toptier', 'name': 'DEPT OF DEFENSE'}] | 0 |  |
| Query C - NAICS + title/lane terms | naics_codes=['561710']; keywords=['fort', 'campbell', 'integrated', 'pest', 'management'] | 25 |  |
| Query D - PSC + title/lane terms | psc_codes=['S207']; keywords=['fort', 'campbell', 'integrated', 'pest', 'management'] | 25 |  |

## Historical Award Summary

- **Deduplicated awards found:** 35
- **Total value:** $69,560,376
- **Award date range:** 2012-03-30 to 2025-09-30
- **Top recipients by returned value/count:**
  - PESTMASTER SERVICES, L.P.: 4 award(s), $7,836,131
  - ALLEYMOR, INC.: 2 award(s), $5,966,341
  - TITAN ASSOCIATES GROUP INC.: 3 award(s), $5,337,709
  - AMERICAN PEST MANAGEMENT INC: 3 award(s), $4,664,507
  - ACCORD FEDERAL SERVICES, LLC: 2 award(s), $4,468,879
- **Most common awarding agencies/subagencies:**
  - Department of the Army: 16 award(s)
  - Department of Veterans Affairs: 8 award(s)
  - Public Buildings Service: 2 award(s)
  - Department of the Air Force: 2 award(s)
...
- **AMERICAN PEST MANAGEMENT INC:** 3 award(s), $4,664,507
- **ACCORD FEDERAL SERVICES, LLC:** 2 award(s), $4,468,879
- **SOLUTIONS A.E. INC.:** 2 award(s), $3,760,281
- **A & M EXTERMINATING SERVICES INC:** 2 award(s), $3,438,506
...
| ALLEYMOR, INC. | $2,347,836 | 2023-03-29 | Department of the Army | PEST MANAGEMENT SERVICES, WEST POINT, NY 10996 | 325320 | S207 | W911SD23F0059 |
...
- Historical range suggests comparable awards span $1,213,386 to $3,908,553, with a median of $1,880,183. This requires validation against scope, period, location, and contract type.
...
- Repeat/large recipients to validate as possible incumbents or teaming intelligence: PESTMASTER SERVICES, L.P., ALLEYMOR, INC., TITAN ASSOCIATES GROUP INC..
